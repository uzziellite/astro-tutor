...
<div class="shadow-md bg-gray-100 dark:bg-gray-900 p-4">
  <form on:submit|preventDefault={bookSkillSession} class="max-w-md mx-auto mt-8 mb-0 space-y-4">
    <div>
      ...
      <div class="relative">
        <input
          type="email"
          class="w-full p-4 pr-12 text-sm border-gray-200 rounded-lg shadow-sm dark:bg-gray-900 dark:text-white"
