              ...
              {#if step === 0}
                ...
                {#if data.who == 'kids'}
                  <fieldset>
                    ...
                    <div class="mt-4 space-y-4">
                      <input id="kids_count" type="range" class="h-4 w-full rounded border-gray-600 text-indigo-600 focus:ring-indigo-500" min="1" max="6" bind:value={data.kids.kids_count}>
                    </div>
